...
class ValueDateTupelTest {
  ...
  void testEqualsObject() {
    ...
    assertEquals(valueDateTupel1, valueDateTupel1_,
        "Two equal instances of ValueDateTupel are not equal");
  }
  ...
  void testIsSortedDescending_arrayContainsNull() {
    ValueDateTupel[] valueDateTupelArray = { valueDateTupel2, null,
        valueDateTupel1 };
    String expectedMessage = "The given array must not contain any null "
        + "LocalDateTime";
  ...
  void testAlignDates_middleMissing() {
    ...
    assertArrayEquals(expectedValue[0], actualValue[0],
        "Dates aren't correct after aligning ValueDateTuples");
    assertArrayEquals(expectedValue[1], actualValue[1],
        "Dates aren't correct after aligning ValueDateTuples");
  }
  ...
  void testAlignDates_arrayNull() {
    String expectedMessage = "The array at position 0 does not meet "
        + "specifications.";
  ...
  void testAlignDates_arrayNotSortedAscending() {
    String expectedMessage = "The array at position 0 does not meet "
        + "specifications.";
    String expectedCause = "Given values are not properly sorted or there "
        + "are non-unique values.";
  ...
  void testContains_unknownElement() {
    ...
    assertFalse(
        ...
        "An unknown element is falsely marked as being in the given "
            + "array");
  }
  ...
  void testContainsDate_unknownDate() {
    ...
    assertFalse(
        ...
        "An unknown DateTime is falsely marked as being in the given "
            + "array");
  }
  ...
  void testAddOneAt_position_negative() {
    String expectedMessage = "Cannot add a value at position < 0. Given "
        + "position is -1";
  ...
  void testAddOneAt_position_greater_arrayLength() {
    String expectedMessage = "Cannot add a value at position > 3. Given "
        + "position is 4.";
  ...
  void testGetPosition() {
    ...
    assertEquals(expectedValueFirstPosition, actualValueFirstPosition,
        "Position cannot be correctly retrieved");
  }
