 ...
 * 
 * @apiNote Tests might fail every 17 in 36^20 cases due to the random generating of file names.
 * @author  Max Rumford
 */
class DataSourceTest {
	...
	/*
	 * Generate random file names as not to accidentally overwrite any existing files
	 */
	...
	void testGetDataFromCsv_day_non_integer() {
		...
		String expectedValue = "The date values of the read CSV file cannot be"
		        + " parsed into numbers. Failing value >01/0z/1981<";
		try {
	...
	void testGetDataFromCsv_month_non_integer() {
		...
		String expectedValue = "The date values of the read CSV file cannot be"
		        + " parsed into numbers. Failing value >0z/01/1981<";
		try {
	...
	void testGetDataFromCsv_year_non_integer() {
		...
		String expectedValue = "The date values of the read CSV file cannot be"
		        + " parsed into numbers. Failing value >01/01/19q1<";
		try {
	...
	void testGetDataFromCsv_hour_non_integer() {
		...
		String expectedValue = "The time values of the read CSV file cannot be"
		        + " parsed into numbers. Failing value >2x:00:00<";
		try {
	...
	void testGetDataFromCsv_minute_non_integer() {
		...
		String expectedValue = "The time values of the read CSV file cannot be"
		        + " parsed into numbers. Failing value >22:x0:00<";
		try {
	...
	void testGetDataFromCsv_second_non_integer() {
		...
		String expectedValue = "The time values of the read CSV file cannot be"
		        + " parsed into numbers. Failing value >22:00:0x<";
		try {
	...
	void testGetDataFromCsv_date_out_of_range() {
		...
		String expectedValue = "The date or time values of the read CSV file "
		        + "cannot be parsed into a LocalDateTime instance. Failing values " + ">15/32/1981< and >22:00:00<.";
		try {
