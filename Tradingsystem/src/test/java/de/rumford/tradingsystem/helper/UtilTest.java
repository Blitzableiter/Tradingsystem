...
class UtilTest {
  ...
  void testGetPositionFromForecast() {
    ...
    assertEquals(LONG, actualValueLong,
        "Position literal for positive forecasts is not inferred.");
    assertEquals(SHORT, actualValueShort,
        "Position literal for negative forecasts is not inferred.");
