...
class ValidatorTest {
	...
	void testValidateRow_onlyNan() {
		ValueDateTupel v1 = new ValueDateTupel(LocalDateTime.of(2019, 1, 1, 22, 0), Double.NaN);
		ValueDateTupel v2 = new ValueDateTupel(LocalDateTime.of(2019, 1, 1, 22, 0), Double.NaN);
		...
		Exception thrown = assertThrows(IllegalArgumentException.class, () -> Validator.validateRow(values),
	...
	void testValidateRow_oneNonNan() {
		ValueDateTupel v1 = new ValueDateTupel(LocalDateTime.of(2019, 1, 1, 22, 0), Double.NaN);
		ValueDateTupel v2 = new ValueDateTupel(LocalDateTime.of(2019, 1, 1, 22, 0), 1d);
		ValueDateTupel[] values = { v1, v2 };
	...
	void testValidateRow_firstNonNan() {
		ValueDateTupel v1 = new ValueDateTupel(LocalDateTime.of(2019, 1, 1, 22, 0), 1d);
		ValueDateTupel v2 = new ValueDateTupel(LocalDateTime.of(2019, 1, 1, 22, 0), Double.NaN);
		ValueDateTupel[] values = { v1, v2 };
	...
	/**
	 * Test method for {@link Validator#validateRulesVsBaseScale( de.rumford.tradingsystem.Rule[], double)}.
	 */
	@Test
	void testValidateRulesVsBaseScale() {
		...
		RealRule rr1 = new RealRule(baseValue, null, startOfRefWindow, endOfRefWindow, baseScale, 1);
		RealRule rr2 = new RealRule(baseValue, null, startOfRefWindow, endOfRefWindow, baseScale, 2);
	...
	void testValidateRulesVsBaseScale_wrongBaseScaleInRule() {
		final double baseScale = 10;
		String expectedMessage = "The rule at index 0 does not share the given" + " base scale of " + baseScale + ".";
		final double wrongBaseScale = 20;
		BaseValue baseValue = BaseValueFactory.jan1Jan31calcShort("TEST");
		LocalDateTime startOfRefWindow = LocalDateTime.of(2020, 1, 10, 22, 0);
		LocalDateTime endOfRefWindow = LocalDateTime.of(2020, 1, 12, 22, 0);

		RealRule rr1 = new RealRule(baseValue, null, startOfRefWindow, endOfRefWindow, wrongBaseScale, 1);
		RealRule rr2 = new RealRule(baseValue, null, startOfRefWindow, endOfRefWindow, baseScale, 2);
