...
public class RuleTest {
	...
	/**
	 * Test method for {@link Rule#validateInputs(BaseValue, Rule[], LocalDateTime, LocalDateTime, double)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link Rule#validateInputs(BaseValue, LocalDateTime, LocalDateTime, double}.
	 */
	@Test
	...
	void testValidateInputs_variationsStartOfRefWindowDoesNotMatchRules() {
		String expectedMessage = "The given reference window does not match "
		        + "the variation's at position 1. The given start of reference " + "window is different.";
		RealRule var1 = RealRule.from(BaseValueFactory.jan1Feb05calcShort(BASE_VALUE_NAME), null,
		        localDateTimeJan10220000, localDateTimeJan12220000, BASE_SCALE, variator);
		RealRule var2 = RealRule.from(BaseValueFactory.jan1Feb05calcShort(BASE_VALUE_NAME), null,
	...
	void testValidateInputs_variationsEndOfRefWindowDoesNotMatchRules() {
		String expectedMessage = "The given reference window does not match "
		        + "the variation's at position 1. The given end of reference " + "window is different.";
		RealRule var1 = RealRule.from(BaseValueFactory.jan1Feb05calcShort(BASE_VALUE_NAME), null,
		        localDateTimeJan10220000, localDateTimeJan12220000, BASE_SCALE, variator);
		RealRule var2 = RealRule.from(BaseValueFactory.jan1Feb05calcShort(BASE_VALUE_NAME), null,
