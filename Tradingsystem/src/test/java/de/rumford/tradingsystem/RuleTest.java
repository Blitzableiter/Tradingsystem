...
public class RuleTest {
  ...
  public static class RealRule extends Rule {
    ...
    public static RealRule from(BaseValue baseValue, Rule[] variations,
        ...
        LocalDateTime endOfReferenceWindow, double baseScale,
        double variator) {
      return new RealRule(baseValue, variations, startOfReferenceWindow,
          endOfReferenceWindow, baseScale, variator);
    }

    @Override
    double calculateRawForecast(LocalDateTime forecastDateTime) {
      return ValueDateTupel
          .getElement(this.getBaseValue().getValues(), forecastDateTime)
    ...
    public boolean equals(Object obj) {
      ...
      if (Double.doubleToLongBits(variator) != Double
          .doubleToLongBits(other.variator))
        return false;
      return true;
    }
  ...
  static void setUpBeforeClass() {
    ...
    localDateTimeJan12220000 = LocalDateTime.of(LocalDate.of(2020, 1, 12),
        LocalTime.of(22, 0));
    localDateTimeFeb05220000 = LocalDateTime.of(LocalDate.of(2020, 2, 5),
        LocalTime.of(22, 0));
    localDateTime2020Dec31220000 = LocalDateTime
        .of(LocalDate.of(2020, 12, 31), LocalTime.of(22, 0));
  }
  ...
  void testCalculateForecastScalar_FcScalarDiv0() {
    String expectedMessage = "Illegal values in calulated forecast values."
        + " Adjust reference window.";

    double variator = -1d;
    realRule = RealRule.from(
        BaseValueFactory.jan1Jan5calcShort_sameValuesOn2To5(
            BASE_VALUE_NAME),
        null, localDateTimeJan02220000, localDateTimeJan05220000,
        BASE_SCALE, variator);
  ...
  void testCalculateForecasts() {
    ...
    double actualValue = ValueDateTupel
        .getElement(realRule.getForecasts(), localDateTimeJan10220000)
        .getValue();

    assertEquals(expectedValue, actualValue,
        "Forecasts are not correctly calculated");
  }
  ...
  void testCalculateScaledForecast_FcNegative20() {
    ...
    variator = -0.1d;
    realRule = RealRule.from(
        BaseValueFactory.jan1Feb05calcShort(BASE_VALUE_NAME), null,
        localDateTimeJan10220000, localDateTimeJan12220000, BASE_SCALE,
        variator);

    ValueDateTupel
        .getElement(realRule.getForecasts(), localDateTimeFeb05220000)
        .getValue();
    double actualValue = ValueDateTupel
        .getElement(realRule.getForecasts(), localDateTimeFeb05220000)
        .getValue();
    ...
    assertEquals(expectedValue, actualValue,
        "Forecasts < -20 are not correctly calculated");
  }
  ...
  void testValidateInputs_startOfReferenceWindow_null() {
    String expectedMessage = "The given reference window does not meet "
        + "specifications.";
    String expectedCause = "Start of time window value must not be null";

    Exception thrown = assertThrows(IllegalArgumentException.class,
        () -> RealRule.from(baseValue, null, null,
            localDateTimeJan12220000, BASE_SCALE, variator),
  ...
  void testValidateInputs_baseScale_0() {
    String expectedMessage = "The given base scale does not meet "
        + "specifications.";
   ...
   */
  @Test
  void testValidateInputs_endOfRefWindow_before_startOfRefWindow() {
    String expectedMessage = "The given reference window does not meet "
        + "specifications.";
    ...
    Exception thrown = assertThrows(IllegalArgumentException.class,
        ...
        "endOfReferenceWindow before startOfReferenceWindow is not "
            + "correctly handled");
  ...
  void testValidateInputs_illegalStartOfReferenceWindow() {
    String expectedMessage = "Given base value and reference window do "
        + "not fit.";
  ...
  void testValidateInputs_illegalEndOfReferenceWindow() {
    String expectedMessage = "Given base value and reference window do not"
        + " fit.";
  ...
  void testValidateInputs_moreThan3Variations() {
    String expectedMessage = "A rule must not contain more than 3 "
        + "variations.";
    RealRule var1 = RealRule.from(
        BaseValueFactory.jan1Feb05calcShort(BASE_VALUE_NAME), null,
        localDateTimeJan10220000, localDateTimeJan12220000, BASE_SCALE,
        variator);
    RealRule var2 = RealRule.from(
        BaseValueFactory.jan1Feb05calcShort(BASE_VALUE_NAME), null,
        localDateTimeJan10220000, localDateTimeJan12220000, BASE_SCALE,
        variator);
    RealRule var3 = RealRule.from(
        BaseValueFactory.jan1Feb05calcShort(BASE_VALUE_NAME), null,
        localDateTimeJan10220000, localDateTimeJan12220000, BASE_SCALE,
        variator);
    RealRule var4 = RealRule.from(
        BaseValueFactory.jan1Feb05calcShort(BASE_VALUE_NAME), null,
        localDateTimeJan10220000, localDateTimeJan12220000, BASE_SCALE,
        variator);
    ...
    Exception thrown = assertThrows(IllegalArgumentException.class,
        () -> RealRule.from(
            BaseValueFactory.jan1Feb05calcShort(BASE_VALUE_NAME),
            variations, localDateTimeJan10220000, localDateTimeJan12220000,
            BASE_SCALE, variator),
  ...
  void testValidateInputs_emptyVariationsArray() {
    String expectedMessage = "The given variations array must not be "
        + "empty.";
    RealRule[] variations = {};
  ...
  void testValidateInputs_variationIsNull() {
    String expectedMessage = "The variation at position 2 in the given "
        + "variations array is null.";
    RealRule var1 = RealRule.from(
        BaseValueFactory.jan1Feb05calcShort(BASE_VALUE_NAME), null,
        localDateTimeJan10220000, localDateTimeJan12220000, BASE_SCALE,
        variator);
   ...
   */
  @Test
  void testValidateInputs_variationsStartOfRefWindowDoesNotMatchRules() {
    String expectedMessage = "The given reference window does not match "
        + "the variation's at position 1. The given start of reference "
        + "window is different.";
    RealRule var1 = RealRule.from(
        BaseValueFactory.jan1Feb05calcShort(BASE_VALUE_NAME), null,
        localDateTimeJan10220000, localDateTimeJan12220000, BASE_SCALE,
    ...
    RealRule var2 = RealRule.from(
        BaseValueFactory.jan1Feb05calcShort(BASE_VALUE_NAME), null,
        localDateTimeJan07220000, localDateTimeJan12220000, BASE_SCALE,
        variator);
    RealRule var3 = RealRule.from(
        BaseValueFactory.jan1Feb05calcShort(BASE_VALUE_NAME), null,
        localDateTimeJan10220000, localDateTimeJan12220000, BASE_SCALE,
   ...
   */
  @Test
  void testValidateInputs_variationsEndOfRefWindowDoesNotMatchRules() {
    String expectedMessage = "The given reference window does not match "
        + "the variation's at position 1. The given end of reference "
        + "window is different.";
    RealRule var1 = RealRule.from(
        BaseValueFactory.jan1Feb05calcShort(BASE_VALUE_NAME), null,
        localDateTimeJan10220000, localDateTimeJan12220000, BASE_SCALE,
    ...
    RealRule var2 = RealRule.from(
        BaseValueFactory.jan1Feb05calcShort(BASE_VALUE_NAME), null,
        localDateTimeJan10220000, localDateTimeFeb05220000, BASE_SCALE,
        variator);
    RealRule var3 = RealRule.from(
        BaseValueFactory.jan1Feb05calcShort(BASE_VALUE_NAME), null,
        localDateTimeJan10220000, localDateTimeJan12220000, BASE_SCALE,
  ...
  void testValidateInputs_variationsDoNotHaveRulesBaseValues() {
    String expectedMessage = "The given variations do not meet "
        + "specifications.";
    String expectedCause = "The base value of all rules must be equal to "
        + "given base value but the rule at position 0 does not comply.";
    RealRule var1 = RealRule.from(
        BaseValueFactory.jan1Jan31calcShort(BASE_VALUE_NAME), null,
        localDateTimeJan10220000, localDateTimeJan12220000, BASE_SCALE,
        variator);
  ...
  void testWeighVariations_1Variation() {
    ...
    RealRule realRule = RealRule.from(
        BaseValueFactory.jan1Feb05calcShort(BASE_VALUE_NAME), variations,
        localDateTimeJan10220000, localDateTimeJan12220000, BASE_SCALE,
        variator);
   ...
   */
  @Test
  void testCalculateForecastScalar_refWindowOnFirstDayOfBaseValues() {
    String expectedMessage = "Reference window must not start on first "
        + "time interval of base value data.";
    double variator3 = 1;

    Exception thrown = assertThrows(IllegalArgumentException.class,
        () -> RealRule.from(
            BaseValueFactory.jan1Feb05calcShort(BASE_VALUE_NAME), null,
            localDateTimeJan01220000, localDateTimeJan03220000, BASE_SCALE,
            variator3),
  ...
  void testCalculateWeights_negativeCorrelations() {
    ...
    assertArrayEquals(expectedValue, actualValue,
        "Weights for variations with negative correlations are not "
