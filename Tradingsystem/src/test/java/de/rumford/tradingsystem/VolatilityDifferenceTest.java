...
class VolatilityDifferenceTest {
  ...
  static void setUpBeforeClass() throws Exception {
    localDateTime2019Dec31220000 = LocalDateTime
        .of(LocalDate.of(2019, 12, 31), LocalTime.of(22, 0));
    localDateTime2020Jan01220000 = LocalDateTime
        .of(LocalDate.of(2020, 1, 1), LocalTime.of(22, 0));
    localDateTime2020Jan02220000 = LocalDateTime
        .of(LocalDate.of(2020, 1, 2), LocalTime.of(22, 0));
    localDateTime2020Jan03220000 = LocalDateTime
        .of(LocalDate.of(2020, 1, 3), LocalTime.of(22, 0));
    localDateTime2020Jan04220000 = LocalDateTime
        .of(LocalDate.of(2020, 1, 4), LocalTime.of(22, 0));
    localDateTime2020Jan05220000 = LocalDateTime
        .of(LocalDate.of(2020, 1, 5), LocalTime.of(22, 0));
    localDateTime2020Jan08220000 = LocalDateTime
        .of(LocalDate.of(2020, 1, 8), LocalTime.of(22, 0));
    localDateTime2020Jan09220000 = LocalDateTime
        .of(LocalDate.of(2020, 1, 9), LocalTime.of(22, 0));
    localDateTime2020Jan10220000 = LocalDateTime
        .of(LocalDate.of(2020, 1, 10), LocalTime.of(22, 0));
    localDateTime2020Jan11220000 = LocalDateTime
        .of(LocalDate.of(2020, 1, 11), LocalTime.of(22, 0));
    localDateTime2020Jan12220000 = LocalDateTime
        .of(LocalDate.of(2020, 1, 12), LocalTime.of(22, 0));
    localDateTime2020Jan31220000 = LocalDateTime
  ...
  void testVolatilityDifference() {
    volatilityDifference = new VolatilityDifference(baseValue, null,
        localDateTime2020Jan03220000, localDateTime2020Jan04220000,
        lookbackWindow, BASE_SCALE);
  ...
  void testVolatilityDifference_volatilityIndicesGiven() {
    ValueDateTupel volatilityIndex1 = new ValueDateTupel(
        localDateTime2020Jan01220000, Double.NaN);
    ValueDateTupel volatilityIndex2 = new ValueDateTupel(
        localDateTime2020Jan02220000, 100d);
    ValueDateTupel volatilityIndex3 = new ValueDateTupel(
        localDateTime2020Jan03220000, 5d);
    ValueDateTupel volatilityIndex4 = new ValueDateTupel(
        localDateTime2020Jan04220000, 10d);
    volatilityIndicesArray = ValueDateTupel.createEmptyArray();
    volatilityIndicesArray = ArrayUtils.add(volatilityIndicesArray,
        volatilityIndex1);
    volatilityIndicesArray = ArrayUtils.add(volatilityIndicesArray,
        volatilityIndex2);
    volatilityIndicesArray = ArrayUtils.add(volatilityIndicesArray,
    ...
    VolatilityDifference volDif = new VolatilityDifference(baseValue, null,
        localDateTime2020Jan02220000, localDateTime2020Jan04220000,
        lookbackWindow, BASE_SCALE, volatilityIndicesArray);
    VolatilityDifference volDif2 = new VolatilityDifference(baseValue,
        null, localDateTime2020Jan02220000, localDateTime2020Jan04220000,
        lookbackWindow, BASE_SCALE, volatilityIndicesArray);

    assertEquals(volDif, volDif2,
        "Two identical instances are not considered identical");
  }
  ...
  void testCalculateVolatilityIndices() {
    double expectedVolatilityValue2 = 0.5303300858899106; // Excel:
    // 0.530330085889911
    double expectedVolatilityValue3 = 0.6010407640085653; // Excel:
    // 0.601040764008565
    ValueDateTupel volatilityIndex1 = new ValueDateTupel(
        localDateTime2020Jan01220000, Double.NaN);
    ValueDateTupel volatilityIndex2 = new ValueDateTupel(
        localDateTime2020Jan02220000, Double.NaN);
    ValueDateTupel volatilityIndex3 = new ValueDateTupel(
        localDateTime2020Jan03220000, expectedVolatilityValue2);
    ValueDateTupel volatilityIndex4 = new ValueDateTupel(
        localDateTime2020Jan04220000, expectedVolatilityValue3);
    ...
    volatilityDifference = new VolatilityDifference(baseValue, null,
        localDateTime2020Jan03220000, localDateTime2020Jan04220000,
        lookbackWindow, BASE_SCALE);
    ValueDateTupel[] actualValues = volatilityDifference
  ...
  void testCalculateVolatilityIndices_lessBaseValuesThanLookbackWindow() {
    ...
    String expectedMessage = "The amount of base values must not be "
        + "smaller than the lookback window. Number of base values: 4, "
        + "lookback window: 10.";

    Exception thrown = assertThrows(IllegalArgumentException.class,
        () -> new VolatilityDifference(baseValue, null,
            localDateTime2020Jan02220000, localDateTime2020Jan04220000,
            lookbackWindowTooGreat, BASE_SCALE),
  ...
  void testValidateVolatilityIndices_volatilityIndicesArrayNull() {
    ...
    Exception thrown = assertThrows(IllegalArgumentException.class,
        () -> new VolatilityDifference(baseValue, null,
            localDateTime2020Jan02220000, localDateTime2020Jan04220000,
            lookbackWindow, BASE_SCALE, null),
  ...
  void testValidateVolatilityIndices_emptyVolatilityIndicesArray() {
    String expectedMessage = "Volatility indices must not be an empty "
        + "array";

    ValueDateTupel[] emptyVolatilityIndicesArray = ValueDateTupel
        .createEmptyArray();

    Exception thrown = assertThrows(IllegalArgumentException.class,
        () -> new VolatilityDifference(baseValue, null,
            localDateTime2020Jan02220000, localDateTime2020Jan04220000,
            lookbackWindow, BASE_SCALE, emptyVolatilityIndicesArray),
        "Empty array of volatlilty indices is not correctly handled");
  ...
  void testValidateVolatilityIndices_unsortedVolatilityIndicesArray() {
    String expectedMessage = "Given volatility indices are not properly "
        + "sorted or there are duplicate LocalDateTime values";
    ...
    ValueDateTupel volatilityIndex2 = new ValueDateTupel(
        localDateTime2020Jan02220000, 100d);
    ValueDateTupel volatilityIndex3 = new ValueDateTupel(
        localDateTime2020Jan04220000, 5d);
    ValueDateTupel volatilityIndex4 = new ValueDateTupel(
        localDateTime2020Jan03220000, 10d);
    volatilityIndicesArray = ValueDateTupel.createEmptyArray();
    volatilityIndicesArray = ArrayUtils.add(volatilityIndicesArray,
        volatilityIndex1);
    volatilityIndicesArray = ArrayUtils.add(volatilityIndicesArray,
  ...
  void testValidateVolatilityIndices_duplicatesInVolatilityIndicesArray() {
    ...
    ValueDateTupel volatilityIndex2 = new ValueDateTupel(
        localDateTime2020Jan02220000, 100d);
    ValueDateTupel volatilityIndex3 = new ValueDateTupel(
        localDateTime2020Jan02220000, 5d);
    ValueDateTupel volatilityIndex4 = new ValueDateTupel(
        localDateTime2020Jan04220000, 10d);
    volatilityIndicesArray = ValueDateTupel.createEmptyArray();
    volatilityIndicesArray = ArrayUtils.add(volatilityIndicesArray,
   ...
   */
  @Test
  void testValidateVolatilityIndices_startOfRefWindowNotInVolIndicesArr() {
    String expectedMessage = "Giving volatility indices do not meet "
        + "specificiation.";
    String expectedCause = "Given values do not include given start "
        + "value for time window";

    ValueDateTupel volatilityIndex2 = new ValueDateTupel(
        localDateTime2020Jan03220000, Double.NaN);
    ValueDateTupel volatilityIndex3 = new ValueDateTupel(
        localDateTime2020Jan04220000, 5d);
    ValueDateTupel volatilityIndex4 = new ValueDateTupel(
        localDateTime2020Jan05220000, 10d);
    volatilityIndicesArray = ValueDateTupel.createEmptyArray();
    volatilityIndicesArray = ArrayUtils.add(volatilityIndicesArray,
        volatilityIndex2);
    volatilityIndicesArray = ArrayUtils.add(volatilityIndicesArray,
    ...
    Exception thrown = assertThrows(IllegalArgumentException.class,
        () -> new VolatilityDifference(baseValue, null,
            localDateTime2020Jan02220000, localDateTime2020Jan04220000,
            lookbackWindow, BASE_SCALE, volatilityIndicesArray),
        "Invalid start of reference window value is not correctly "
            + "handled");
   ...
   */
  @Test
  void testValidateVolatilityIndices_endOfRefWindowNotInVolIndicesArray() {
    String expectedMessage = "Giving volatility indices do not meet "
        + "specificiation.";
   ...
   */
  @Test
  void testValidateVolatilityIndices_nansInRelevantAreaOfVolIndicesArr() {
    String expectedMessage = "There must not be NaN-Values in the given "
        + "volatility indices values in the area delimited by "
        + "startOfReferenceWindow and endOfReferenceWindow";

    ValueDateTupel volatilityIndex1 = new ValueDateTupel(
        localDateTime2020Jan01220000, 100d);
    ValueDateTupel volatilityIndex2 = new ValueDateTupel(
        localDateTime2020Jan02220000, 100d);
    ValueDateTupel volatilityIndex3 = new ValueDateTupel(
        localDateTime2020Jan03220000, Double.NaN);
    ...
    Exception thrown = assertThrows(IllegalArgumentException.class,
        () -> new VolatilityDifference(baseValue, null,
            localDateTime2020Jan02220000, localDateTime2020Jan04220000,
            lookbackWindow, BASE_SCALE, volatilityIndicesArray),
        "NaNs in relevant area of volatility indices are not correctly "
            + "handled");
   ...
   */
  @Test
  void testValidateVolatilityIndices_baseValueVolIndicesNotAligned() {
    String expectedMessage = "Base value and volatility index values are "
        + "not properly aligned. Utilize "
        + "ValueDateTupel.alignDates(ValueDateTupel[][]) before creating a"
        + " new VolatilityDifference.";
    ...
    ValueDateTupel volatilityIndex4 = new ValueDateTupel(
        localDateTime2020Jan04220000, 10d);
    ValueDateTupel volatilityIndex5 = new ValueDateTupel(
        localDateTime2020Jan05220000, 99d);
    volatilityIndicesArray = ValueDateTupel.createEmptyArray();
    volatilityIndicesArray = ArrayUtils.add(volatilityIndicesArray,
        volatilityIndex1);
    volatilityIndicesArray = ArrayUtils.add(volatilityIndicesArray,
    ...
    Exception thrown = assertThrows(IllegalArgumentException.class,
        () -> new VolatilityDifference(baseValue, null,
            localDateTime2020Jan02220000, localDateTime2020Jan04220000,
            lookbackWindow, BASE_SCALE, volatilityIndicesArray),
        "Not aligned base value and volatility indices are not correctly "
            + "handled");
  ...
  void testCalculateRawForecast() {
    ...
    VolatilityDifference volDif = new VolatilityDifference(baseValue, null,
        localDateTime2020Jan08220000, localDateTime2020Jan10220000,
        lookbackWindow, BASE_SCALE);
    double actualValue = volDif
        .calculateRawForecast(localDateTime2020Jan11220000);

    assertEquals(expectedValue, actualValue,
        "Raw Forecast is not correctly calculated");
  }
}