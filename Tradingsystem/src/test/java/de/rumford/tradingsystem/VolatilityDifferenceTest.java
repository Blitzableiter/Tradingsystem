...
class VolatilityDifferenceTest {
	...
	/**
	 * Test method for {@link VolatilityDifference#calculateVolatilityIndices(BaseValue, int)}.
	 */
	@Test
	...
	void testCalculateVolatilityIndices_lessBaseValuesThanLookbackWindow() {
		...
		String expectedMessage = "The amount of base values must not be "
		        + "smaller than the lookback window. Number of base values: 4, " + "lookback window: 10.";
	...
	/**
	 * Test method for {@link VolatilityDifference#validateVolatilityIndices( ValueDateTupel[])}.
	 */
	@Test
	...
	void testValidateVolatilityIndices_baseValueVolIndicesNotAligned() {
		String expectedMessage = "Base value and volatility index values are " + "not properly aligned. Utilize "
		        + "ValueDateTupel.alignDates(ValueDateTupel[][]) before creating a" + " new VolatilityDifference.";
